...
Module 6 — текущий локальный committed candidate: для него выполнен локальный синтетический
pilot QuietFollow по набору из 21 выбранного E-case; candidate не интегрирован и не выпущен.
...
- Локальный синтетический pilot QuietFollow охватывает только 21 выбранный E-case и не доказывает
  полное покрытие E01–E41, live-routing или production behavior; механический contract test
  отдельно не является поведенческим подтверждением.
